...
# --- molecule images (WEBP base64 for compact HTML) ---
...
panel_b["mol_img"] = panel_b["smiles"].apply(smiles_to_webp)
...
# --- swarm images (reuses make_swarm_svg & peak_areas from figure_1) ---

panel_b["swarm_img"] = panel_b["ocnt_batch"].map(
    lambda b: svg_to_webp_b64(make_swarm_svg(b, peak_areas, enzymes=["CYP3A4"]))
)
```
