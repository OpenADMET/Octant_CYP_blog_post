...
#| output: false
#| cache.extra: !expr list(tools::md5sum(here("R", "helpers.R")), tools::md5sum(here("data", "rds", "RWT115_anno_data_df.RDS")))
...
#| output: false
#| cache.extra: !expr list(tools::md5sum(here("R", "helpers.R")), tools::md5sum(here("data", "rds", "RWT92_norm_data.RDS")))
...
#| output: false
#| cache.extra: !expr list(tools::md5sum(here("R", "helpers.R")), tools::md5sum(here("data", "rds", "RWT112_anno_data_df.RDS")))
...
#| output: false
#| cache.extra: !expr tools::md5sum(here("post", "figures", "assets", "Jan_2026_OpenADMET_CYP_blog_2D.png"))

fig_2d <- wrap_elements(
  grid::rasterGrob(
    png::readPNG(here("post", "figures", "assets", "Jan_2026_OpenADMET_CYP_blog_2D.png")),
    interpolate = TRUE
  )
)
```
...
#| fig-width: 7
#| fig-height: 8
#| cache.extra: !expr list(tools::md5sum(here("R", "helpers.R")), tools::md5sum(here("data", "rds", "RWT115_anno_data_df.RDS")), tools::md5sum(here("data", "rds", "RWT92_norm_data.RDS")), tools::md5sum(here("data", "rds", "RWT112_anno_data_df.RDS")), tools::md5sum(here("post", "figures", "assets", "Jan_2026_OpenADMET_CYP_blog_2D.png")))
