...
# join SMILES
react_log2 = react_log2.merge(cpds, on="ocnt_batch", how="left").dropna(subset=["standardized_smiles"])
react_pct = react_pct.merge(cpds, on="ocnt_batch", how="left").dropna(subset=["standardized_smiles"])

# --- render molecule images ---

react_log2["mol_img"] = react_log2["standardized_smiles"].apply(smiles_to_webp)
react_pct["mol_img"] = react_pct["standardized_smiles"].apply(smiles_to_webp)
